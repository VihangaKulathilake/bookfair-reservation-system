...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT p FROM Payment p LEFT JOIN FETCH p.reservation r LEFT JOIN FETCH r.user u LEFT JOIN FETCH r.stalls s WHERE u.id = :userId")
